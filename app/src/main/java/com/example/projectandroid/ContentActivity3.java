...
public class ContentActivity3 extends AppCompatActivity implements View.OnClickListener {
    ...
    private void openPage(int pageNumber) {
        ...
        switch (pageNumber) {
            case 1:
                intent = new Intent(ContentActivity3.this, ContentActivity1.class); // เปิดหน้า 1
                break;
            case 2:
                intent = new Intent(ContentActivity3.this, ContentActivity2.class); // เปิดหน้า 2
                break;
            case 3:
                intent = new Intent(ContentActivity3.this, ContentActivity3.class); // เปิดหน้า 3
                break;
            case 4:
                intent = new Intent(ContentActivity3.this, ContentActivity4.class); // เปิดหน้า 4
                break;
            case 5:
                intent = new Intent(ContentActivity3.this, ContentActivity5.class); // เปิดหน้า 5
                break;
            default:
                // ถ้า pageNumber เกินขอบเขต ก็เปิดหน้าแรก
                intent = new Intent(ContentActivity3.this, ContentActivity3.class);
                break;
        }
        intent.putExtra("user",user);
        startActivity(intent);
